...
export default function EmployeeRequests(){
  ...
  return(
    ...
    <Table className={classes.table} aria-label="simple table">
          ...
          <StyledTableCell align="left"style={{width:100}}>Request DateTime</StyledTableCell>
          </TableRow>
          </TableHead>
          <TableBody>
          {decRequests.map((request) => (
            ...
            <StyledTableCell align="left"style={{width:100}}>{request.Description}</StyledTableCell>
            <StyledTableCell align="left"style={{width:100}}>{request.createdAt}</StyledTableCell>
            </StyledTableRow>
          ))}
          </TableBody>
          </Table>
