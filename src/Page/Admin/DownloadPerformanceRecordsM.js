...
export default function DownloadPerformanceRecordsM(){
  ...
  return(
      ...
      Download Performance Records (Managers)
      </Typography>
      <br></br>
      <br></br>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText id="alert-dialog-description">
                Are you sure you want to download the performance records of this manager?
              </DialogContentText>
            </DialogContent>
            <DialogActions>
